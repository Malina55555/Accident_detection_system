...
USE_REAL_RTDETR = True  #True  # False - заглушка, True - реальная модель

# VLM1 (Gemma)
VLM1_MODEL_NAME = "google/gemma-4-e2b-it"
USE_REAL_VLM1 = True  # False - заглушка, True - реальная модель  Прим-е: заглушка использует реальный вывод модели, но из другого устройства

# ==========================================================
# REPORT SETTINGS
# ==========================================================
REPORT_SAVE_PATH = None # заменить на директорию с отчтами, н-р: r"C:\Users\User\Diplom\reports" 
FONTS_PATH = None # заменить на путь к русскому шрифту, н-р: r"C:\Users\User\Diplom\verification_service\fonts\times.ttf"  # Путь к шрифту для PDF
